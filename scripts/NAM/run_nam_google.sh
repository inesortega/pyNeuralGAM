...
python nam_train.py logistic -d uniform -o results-nam-ortega-1024-exu -i $SLURM_ARRAY_TASK_ID
python test_nam.py logistic -d uniform -o results-nam-ortega-1024-exu -i $SLURM_ARRAY_TASK_ID

rm -r results-nam-ortega-1024-exu/$SLURM_ARRAY_TASK_ID/uniform_binomial/model/

python nam_train.py linear -d uniform -t homoscedastic -o results-nam-ortega-1024-exu -i $SLURM_ARRAY_TASK_ID
python test_nam.py linear -d uniform -t homoscedastic -o results-nam-ortega-1024-exu -i $SLURM_ARRAY_TASK_ID

rm -r results-nam-ortega-1024-exu/$SLURM_ARRAY_TASK_ID/homoscedastic_uniform_gaussian/model/

python nam_train.py linear -d uniform -t heteroscedastic -o results-nam-ortega-1024-exu -i $SLURM_ARRAY_TASK_ID
python test_nam.py linear -d uniform -t heteroscedastic -o results-nam-ortega-1024-exu -i $SLURM_ARRAY_TASK_ID
