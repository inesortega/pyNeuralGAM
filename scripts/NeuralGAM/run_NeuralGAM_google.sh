...
python main_google.py logistic -d uniform -o results -c 0.00001 -a 0.1 -i $SLURM_ARRAY_TASK_ID
python main_google.py linear -d uniform -t homoscedastic -o results -c 0.00001 -a 0.1 -i $SLURM_ARRAY_TASK_ID 
python main_google.py logistic -d uniform -t heteroscedastic -o results -c 0.00001 -a 0.1 -i $SLURM_ARRAY_TASK_ID 
echo "Starting test..."
