...
#SBATCH -J NeuralGAM_Scenario_I_R3 #job name
...
#SBATCH --mem=16G
#SBATCH -o logs/NeuralGAM_Scenario_I_R3.out #specify stdout output file (%A expands to array jobID, %a expands to array task id)
...
do
    ...
    python main_simulation.py logistic -d uniform -i $i -c 10e-5 -a 0.1 -u 1024 -o results_NeuralGAM_Scenario_I
